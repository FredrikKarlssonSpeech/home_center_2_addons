...
motionSensorID    = {276};  -- change id for your motion sensor.
LuxSensorID       = {83};  -- change id for your light sensor.
...
lightsMorning  = {{id=268, setValue="30", onTime=300}};
lightsDay      = {{id=268, setValue="60", onTime=300}};
lightsEvening  = {{id=268, setValue="50", onTime=300}};
lightsNight    = {{id=268, setValue="30", onTime=300}};
