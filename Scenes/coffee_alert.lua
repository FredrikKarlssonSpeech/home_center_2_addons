...
local prev = tostring(fibaro:getGlobal("Coffe_machine"));
local lastModified =  fibaro:getGlobalModificationTime("Coffe_machine");
...
elseif (consumption < 100 and (prev == "Rinsing" or timeElapsedMinutes > 60)) then
    ...
    fibaro:setGlobal("Coffe_machine", "Off");
end;
